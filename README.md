...
## Notes & Next Steps
- Passwords are stored in plaintext for demo simplicity; swap to bcrypt before any real use.
- Add rate limits + input validation for production.
- Consider moving shared config (ports, base URLs) to env-driven Vite variables.
